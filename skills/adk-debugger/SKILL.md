...
| File | Contents |
|------|----------|
| `references/traces.md` | CLI debugging tools, log querying, trace structure, span types, `onTrace` hooks, reproduction with `adk chat` |
...
1. **"How do I read traces/logs?"** → Read `traces.md` for CLI commands and trace structure
