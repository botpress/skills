...
- **Missing config:** Run `adk integrations info <name> --format json` to see required config, then configure in Dev Console which must also be done interactively
...
- **Config:** Run `adk integrations info <name> --format json` to verify required fields, update in Dev Console
